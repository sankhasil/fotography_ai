...
describe('PenguinBuilder scenes', () => {
  ...
  it('swaps to the building scene at the 50% boundary', () => {
    ...
    expect(wrapper.find('.penguin-hat').exists()).toBe(true)
  })
